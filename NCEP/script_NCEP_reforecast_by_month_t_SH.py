#!/usr/bin/env python
#       Python code to retrieve the complete NCEP reforecasts for a single variable (in this case u)
#       and over a specified region (in this case Southern Hemisphere) and at multiple levels. The script will retrieve one grib file per hdate
#
