...
# Agrego Path
pathto="/datos/S2S/ECMWF_OLD/"

# ECMWF version 2018

model_date_mon = "2018-08-02"
model_date_thu = "2018-08-06"
...
for dy in year_list:
    ...
    while (modeldatemon <= datetime.strptime("2018-12-31", "%Y-%m-%d")):
    ...
    while (modeldatethu <= datetime.strptime("2018-12-31", "%Y-%m-%d")):
