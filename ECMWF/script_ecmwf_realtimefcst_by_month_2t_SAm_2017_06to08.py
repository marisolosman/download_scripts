...
# Agrego Path
pathto="/media/mariano/371BA83C4BFB071E/mariano/S2S_data/ECMWF/"

# ECMWF version 2017

starts_06=["0601","0608","0615","0622","0629"]
starts_07=["0706","0713","0720","0727"]
starts_08=["0803","0810","0817","0824","0831"]
...
for dy in year_list:
        for dm in month_list:
                ...
                file_name=[ pathto, "ECMWF_", variable, "_", region, "_pf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".grib"];
                ...
                string="";
                command_pf=[ "grib_to_netcdf -M -I method,type,stream,refdate -T -o ", pathto, "ECMWF_", variable, "_",region, "_pf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".nc ", pathto, "ECMWF_", variable, "_",region, "_pf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".grib"];
                call(string.join(command_pf), shell=True)

                string="";

                file_name=[pathto, "ECMWF_",variable, "_", region, "_cf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".grib"];
                ...
                string="";
                command_pf=[ "grib_to_netcdf -M -I method,type,stream,refdate -T -o ", pathto, "ECMWF_", variable, "_", region, "_cf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".nc ", pathto, "ECMWF_", variable, "_", region, "_cf_realtimefcst_", str(dy),"_", month_name_list[dm-1] , ".grib"];
                call(string.join(command_pf), shell=True)
