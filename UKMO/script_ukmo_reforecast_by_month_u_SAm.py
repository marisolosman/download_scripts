...
# Agrego Path
pathto="/mnt/datos2/S2S_data/UKMO/u850/"
...
for dy in year_list:
	for dm in month_list:
		...
		range_dates += string.join([str(2016),eval(string.join(["starts_",month_name_list[dm-1] , "[range_end-1]"]))])
    		...
    		file_name=[ pathto, "UKMO_", variable, "_", region, "_pf_reforecast_", str(dy),"_", month_name_list[dm-1] , ".grib"];
		...
		file_name=[pathto, "UKMO_",variable, "_", region, "_cf_reforecast_", str(dy),"_", month_name_list[dm-1] , ".grib"];
