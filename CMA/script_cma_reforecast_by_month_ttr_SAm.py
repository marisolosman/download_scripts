...
##
#	Python code to retrieve the complete CMA reforecasts for a single variable (in this case top total radiation -OLR-)
...
origen="babj"
moddate="2014-05-01"
paso="24/to/1440/by/24"
num="1/2/3"

# Agrego Path
pathto="/mnt/datos2/S2S_data/CMA/olr/"
