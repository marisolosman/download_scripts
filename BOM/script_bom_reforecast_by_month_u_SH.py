...
for dy in year_list:
        for dm in month_list:
                ...
                MMYY=str(dy) + month_name_list[dm - 1]
                print(MMYY)
...
#                date_range=[str(dy), month_name_list[dm-1], day_name_list[0], "/to/", str(dy), month_name_list[dm-1], day_name_list[len(day_list)-1]];
                ...
                fn = [ pathto, "BOM_", variable, "_", region, "_pf_reforecast_", str(dy),"_", month_name_list[dm-1] , ".nc"]
                if not os.path.isfile("".join(fn)):
                ...
                fn = [ pathto, "BOM_", variable, "_", region, "_cf_reforecast_", str(dy),"_", month_name_list[dm-1] , ".nc"]
                if not os.path.isfile("".join(fn)):
